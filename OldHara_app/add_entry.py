...
def check_doi(nameDOI):
    ...
    return isDOIValid, text

def validate_check_biblio(validated_doi, validated_id):
    crossrefurl = 'https://api.crossref.org/v1/works/' + validated_doi
    r = requests.get(crossrefurl)
    ...
    if r.status_code == 200:
        ...
        c = Biblio.objects.get(id = validated_id)
